...
set PROC=%CP%;c:\projects\deors.demos\annotations\deors.demos.annotations.beaninfo.processors\target\deors.demos.annotations.beaninfo.processors-1.0-SNAPSHOT.jar
