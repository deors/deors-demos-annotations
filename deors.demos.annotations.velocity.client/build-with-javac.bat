...
set CP=%ROOT_FOLDER%\deors.demos\annotations\deors.demos.annotations.velocity\target\deors.demos.annotations.velocity-1.0-SNAPSHOT.jar
set PROC=%CP%;%ROOT_FOLDER%\deors.demos\annotations\deors.demos.annotations.velocity.processors\target\deors.demos.annotations.velocity.processors-1.0-SNAPSHOT.jar
