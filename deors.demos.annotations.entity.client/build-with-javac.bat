...
set CP=c:\projects\deors.demos\annotations\deors.demos.annotations.entity\target\deors.demos.annotations.entity-1.0-SNAPSHOT.jar
set PROC=%CP%;c:\projects\deors.demos\annotations\deors.demos.annotations.entity.processors\target\deors.demos.annotations.entity.processors-1.0SNAPSHOT.jar
